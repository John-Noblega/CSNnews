<section class="contenedor">
			...
			<section class="maincontent">
				<section class="content">					
					...
					<div id="lcontain">
			  			<h1>Registrarse</h1>					
						<form class="contact_form" action="registro" method="get">
						    <ul>
						     	<li>
						           <label for="username"><img src="/imagenes/_user.png" class="icono_img">Username:</label>
						           <input type="text" name="username" placeholder="Alias" required="">
						       </li>
						       ...
						       <li>
						           ...
						           <input type="text" name="name" placeholder="Johan Ricardo" required="">
						       </li>
						       <li>
